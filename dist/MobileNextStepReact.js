...
const MobileNextStepReact = ({ children, steps, shadowRgb = '0, 0, 0', shadowOpacity = '0.2', cardTransition = { ease: 'anticipate', duration: 0.6 }, cardComponent: CardComponent, onStart = () => { }, onStepChange = () => { }, onComplete = () => { }, onSkip = () => { }, displayArrow = true, clickThroughOverlay = false, navigationAdapter = useWindowAdapter, disableConsoleLogs = false, scrollToTop = true, noInViewScroll = false, }) => {
    ...
    const getCardStyle = (side) => {
        ...
        // For small screens, always center the tooltip in the middle of the screen
        if (isSmallScreen()) {
            return {
                position: 'fixed',
                top: '50%',
...
export default MobileNextStepReact;
